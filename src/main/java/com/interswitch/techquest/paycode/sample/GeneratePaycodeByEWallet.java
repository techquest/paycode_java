...
public class GeneratePaycodeByEWallet  extends BaseSample {
    ...
    public static void main(String[] args) {
        ...
        try {
    		...
    		String cvv = "111";
    		String pin = "1111";    		
    		String amt = "200000"; // Minor denomination. This is same as 2,000
    		String ttid = "809";
    		String fep = "455";
...
//    			PaymentMethod paymentMethod = eWalletPaymentMethodResponse.getPaymentMethods()[0];
    			String paymentMethodIdentifier =  "E192F3F3B3BA4596BC9704C44EA801BC"; //paymentMethod.getToken(); //"E192F3F3B3BA4596BC9704C44EA801BC"; 
    			
    			
    			EWalletPaycodeRequest paycodeRequest = new EWalletPaycodeRequest(msisdn, ttid, paymentMethodIdentifier, expDate, cvv, pin, amt, fep, tranType, pwmChannel, codeGenerationChannel, tokenLifeInMin, oneTimePin);
